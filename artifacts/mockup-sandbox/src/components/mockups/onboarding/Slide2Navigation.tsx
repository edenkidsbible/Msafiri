...
export function Slide2Navigation() {
  const features = [
    { icon: <Shield size={22} color={ACCENT} />, title: "Camera-Aware", sub: "See every camera ahead" },
    { icon: <Clock size={22} color={ACCENT} />, title: "ETA + Delays", sub: "Traffic accounted for" },
    { icon: <Route size={22} color={ACCENT} />, title: "Alt Routes", sub: "Pick the safest path" },
  ];
    ...
    <div className="w-[390px] h-[844px] bg-white flex flex-col overflow-hidden select-none">
      ...
      <div className="flex justify-center pt-5">
        <div className="w-28 h-28 rounded-[32px] flex items-center justify-center shadow-sm" style={{ backgroundColor: ACCENT_LIGHT }}>
          <Navigation size={58} color={ACCENT} strokeWidth={1.5} />
        </div>
      </div>
