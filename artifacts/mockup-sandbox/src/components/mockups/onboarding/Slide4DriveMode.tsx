...
export function Slide4DriveMode() {
  const features = [
    { icon: <Gauge size={22} color={ACCENT} />, title: "Live Speed", sub: "Real GPS km/h always visible" },
    { icon: <Eye size={22} color={ACCENT} />, title: "Zone Limit", sub: "Current road's speed limit" },
    { icon: <AlertTriangle size={22} color={ACCENT} />, title: "Overspeed Alert", sub: "Red warning instantly" },
  ];
