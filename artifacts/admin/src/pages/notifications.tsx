  ...
  return (
    <AdminLayout>
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <PageGuide
          title="Reviewing system notifications"
          steps={[
            { label: "What appears here", detail: "these are internal team alerts generated by system events — not push notifications sent to app users." },
            { label: "Mark read or delete", detail: "click an item to mark it read, or delete it once actioned; use Mark All Read to clear the unread count in one go." },
            { label: "Types", detail: "info, warning, error, and success alerts surface events such as failed jobs, quota breaches, or completed operations." },
          ]}
        />
