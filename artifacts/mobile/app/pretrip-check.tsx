...
export default function PretripCheckScreen() {
  ...
  // ── Start driving ──────────────────────────────────────────────────────────
  // Goes directly to the Drive screen — the inline camera preview in the
  // Dashcam Setup card is sufficient for the driver to verify their mount angle
  // before tapping this button, so no extra orientation-confirm step is needed.
          ...
          <>
            ...
            <View style={[styles.card, { backgroundColor: c.card, borderColor: c.border }]}>
              ...
              <Text style={[styles.previewHint, { color: c.mutedForeground }]}>
                Adjust your phone mount so the road ahead fills this view, then tap Start Driving below
              </Text>
