...
const styles = StyleSheet.create({
  ...
  clusterWrap: { width: 46, height: 46, alignItems: "center", justifyContent: "center" },
  clusterGrid: { width: 36, height: 36, flexWrap: "wrap", flexDirection: "row", gap: 2, borderRadius: 10, overflow: "hidden" },
  clusterCell: { width: 17, height: 17, alignItems: "center", justifyContent: "center", borderRadius: 4 },
