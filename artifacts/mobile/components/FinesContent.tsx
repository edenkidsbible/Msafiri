...
export default function FinesContent() {
  ...
  const scrollPad    = bottomInset + tabBarHeight + 16;
  ...
  return (
    <View style={{ flex: 1 }}>
      {/* ── Subtitle ── */}
      <Text style={[styles.sub, { color: c.mutedForeground, paddingHorizontal: 20, marginBottom: 8 }]}>
        Minor Offences Rules (LN 161/2016) &amp; Traffic Act
      </Text>

      {/* ── Section tabs: Fines / How to Pay / Contest ── */}
      <View style={[styles.sectionRow, { backgroundColor: c.muted, marginHorizontal: 16, marginBottom: 6 }]}>
      ...
      {section === "fines" && (
        <>
          ...
          <FlatList
            ...
            ListHeaderComponent={
              activeCat === "speeding" ? (
                <View style={[styles.speedNote, { backgroundColor: "#E5393512", borderColor: "#E5393530" }]}>
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                <View style={[
                  styles.amountBadge,
                  { backgroundColor: amountColor(item) + "15", borderColor: amountColor(item) + "30" },
                ]}>
            ...
            ListEmptyComponent={
              <View style={styles.empty}>
                <Text style={[styles.emptyText, { color: c.mutedForeground }]}>No matching offences</Text>
              </View>
            }
          />
        </>
      ...
      {section === "pay" && (
        <ScrollView
          contentContainerStyle={{ padding: 16, paddingBottom: scrollPad }}
      ...
      {section === "contest" && (
        ...
        >
          ...
          <View style={[styles.payCard, { backgroundColor: c.card, borderColor: c.border }]}>
            <Text style={[styles.payTitle, { color: c.foreground, marginBottom: 14, padding: 13 }]}>
          ...
          <View style={[styles.infoNote, { backgroundColor: c.muted }]}>
            <Text style={{ color: c.mutedForeground, fontSize: 13, fontFamily: "Inter_600SemiBold", marginBottom: 6 }}>
              Need Legal Help?
            </Text>
            <Text style={{ color: c.mutedForeground, fontSize: 13, marginBottom: 2 }}>Law Society of Kenya (LSK)</Text>
            <Text style={{ color: c.mutedForeground, fontSize: 13, marginBottom: 2 }}>Lavington, Opposite Valley Arcade, Gitanga Road</Text>
            <Text style={{ color: c.mutedForeground, fontSize: 13, marginBottom: 2 }}>P.O Box 72219-00200, Nairobi, Kenya</Text>
            <Text style={{ color: c.mutedForeground, fontSize: 13, marginBottom: 2 }}>📞 +254-799-595-800</Text>
            <Text style={{ color: c.mutedForeground, fontSize: 13 }}>✉️  lsk@lsk.or.ke</Text>
          </View>
        </ScrollView>
      )}
    </View>
...
const styles = StyleSheet.create({
  ...
  catRow: { flexDirection: "row", paddingHorizontal: 14, paddingVertical: 8, gap: 6 },
  catChip: {
    flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 5, paddingVertical: 7, paddingHorizontal: 6, borderRadius: 10, borderWidth: 1.5,
  },
  ...
  pointsBadge: { alignSelf: "flex-start", paddingHorizontal: 7, paddingVertical: 2, borderRadius: 6, marginTop: 4 },
  pointsText: { fontSize: 11, fontFamily: "Inter_600SemiBold" },
  amountBadge: {
    borderRadius: 8, borderWidth: 1, paddingHorizontal: 9, paddingVertical: 4,
    alignSelf: "flex-start", marginTop: 2, minWidth: 72, alignItems: "center",
  },
  amount: { fontSize: 13, fontFamily: "Inter_700Bold", textAlign: "center" },
  empty: { alignItems: "center", paddingTop: 40 },
  emptyText: { fontSize: 14, fontFamily: "Inter_400Regular" },

  sectionHeading: { fontSize: 15, fontFamily: "Inter_600SemiBold", marginBottom: 10 },
  enforcementCard: {
    flexDirection: "row", alignItems: "flex-start", gap: 12,
    borderRadius: 12, borderWidth: 1, padding: 12, marginBottom: 8,
  },
  enforcementIcon: { width: 38, height: 38, borderRadius: 10, alignItems: "center", justifyContent: "center", flexShrink: 0 },
  ...
  infoNote: { borderRadius: 12, padding: 13, marginBottom: 14, fontSize: 13, lineHeight: 18 },

  payCard: { borderRadius: 14, borderWidth: 1, marginBottom: 12, overflow: "hidden" },
  payHeader: { flexDirection: "row", alignItems: "center", padding: 13, gap: 12 },
  ...
  stepNum: { width: 20, height: 20, borderRadius: 10, alignItems: "center", justifyContent: "center", marginTop: 1, flexShrink: 0 },
