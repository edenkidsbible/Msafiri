...
export const SPEED_ZONES: SpeedZone[] = [
  ...
  { id: "sz003", name: "Machakos Junction Police", road: "Mombasa Road (A109)", lat: -1.485155, lng: 37.017639, speedLimit: 80, type: "police", description: "Frequent radar checks. Limit: 80 km/h" },
  ...
  { id: "sz005", name: "Sultan Hamud Camera", road: "Mombasa Road (A109)", lat: -2.01789, lng: 37.372371, speedLimit: 50, type: "camera", description: "Town camera. Limit: 50 km/h" },
  ...
  { id: "sz031", name: "Thika Road – Safari Park", road: "Thika Superhighway (A2)", lat: -1.225537, lng: 36.883456, speedLimit: 100, type: "camera", description: "Mobile speed check near Safari Park Hotel heading towards Kasarani. Limit: 100 km/h" },
  { id: "sz032", name: "Thika Road – Jomoko Turnoff", road: "Thika Superhighway (A2)", lat: -1.140128, lng: 36.970206, speedLimit: 80, type: "camera", description: "Fixed ANPR camera at Jomoko turnoff between Ruiru and Juja. Limit: 80 km/h" },
  ...
  { id: "sz035",  name: "Mombasa Rd Zone – Nyayo Stadium end",    road: "Mombasa Road (A109)", lat: -1.310274, lng: 36.825258, speedLimit: 80, type: "zone", description: "Speed zone: Nyayo Stadium → Sameer Business Park. Approaching from Nairobi CBD side. Limit: 80 km/h" },
  { id: "sz035b", name: "Mombasa Rd Zone – Sameer Business Park end", road: "Mombasa Road (A109)", lat: -1.316419, lng: 36.876234, speedLimit: 80, type: "zone", description: "Speed zone: Nyayo Stadium → Sameer Business Park. Approaching from Mlolongo/JKIA side. Limit: 80 km/h" },
