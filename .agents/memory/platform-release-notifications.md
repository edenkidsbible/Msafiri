...
**How to apply:** Keep immediate publishing and scheduled release promotion on the same notification path. New releases should require an explicit iOS or Android target; retain combined releases only to manage historical records or a deliberate cross-platform broadcast.